...
class LocalitiesControllerTest < ActionController::TestCase
  ...
  test "should update locality" do
    patch :update, id: @locality, locality: { areacode: @locality.areacode, freight_cod: @locality.freight_cod, freight_paid: @locality.freight_paid, level: @locality.level, name: @locality.name, parent: @locality.parent, sort: @locality.sort, telcode: @locality.telcode, zipcode: @locality.zipcode }
    assert_redirected_to locality_path(assigns(:locality))
  end
